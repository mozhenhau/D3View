//
//  D3CollectionView,此类除了继承的类外，其他一模一样....不想写成成员变量，未想到好方法
//  Neighborhood
//
...
class D3CollectionView: UICollectionView {
    ...
    var parms:Array<Int>?  //这个是getGoodsByCate的特例。。。其他情况用不到
