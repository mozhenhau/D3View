 ...
 *  @param keyValues 字典
 */
- (id)setKeyValues:(id)keyValues;
- (id)setKeyValues:(id)keyValues error:(NSError **)error;
 ...
 */
- (id)setKeyValues:(id)keyValues context:(NSManagedObjectContext *)context;
- (id)setKeyValues:(id)keyValues context:(NSManagedObjectContext *)context error:(NSError **)error;
...
+ (id)objectWithKeyValues:(id)keyValues error:(NSError **)error;
 ...
 *  @return 新建的对象
 */
+ (id)objectWithKeyValues:(id)keyValues context:(NSManagedObjectContext *)context;
+ (id)objectWithKeyValues:(id)keyValues context:(NSManagedObjectContext *)context error:(NSError **)error;
...
+ (id)objectWithFilename:(NSString *)filename error:(NSError **)error;
 ...
 *  @return 新建的对象
 */
+ (id)objectWithFile:(NSString *)file;
+ (id)objectWithFile:(NSString *)file error:(NSError **)error;
