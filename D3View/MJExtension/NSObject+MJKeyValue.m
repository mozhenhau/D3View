...
+ (instancetype)objectWithJSONData:(NSData *)data error:(NSError *__autoreleasing *)error
{
    ...
    return [self objectWithKeyValues:[NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingMutableContainers error:nil] error:error];
}
...
+ (instancetype)objectWithKeyValues:(id)keyValues
{
    ...
    {
        dic = (NSDictionary*)[keyValues lastObject];
    }
    else
    {
        dic = keyValues;
