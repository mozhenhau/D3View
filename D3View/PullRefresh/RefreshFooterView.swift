...
class RefreshFooterView: RefreshBaseView {
    ...
    var footerPullDescription:String = "上拉可以加载更多数据"
    var footerReleaseDescription:String = "松开立即加载更多数据"
    ...
    didSet{
        switch State{
        case .Normal:
            self.statusLabel.text = footerPullDescription;
            ...
            break
        case .Pulling:
            self.statusLabel.text = footerReleaseDescription
            UIView.animateWithDuration(RefreshSlowAnimationDuration, animations: {
